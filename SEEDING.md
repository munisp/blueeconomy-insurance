...
into every table of the marine insurance schema.
...
```sh
# apply migrations
INSURANCE_DATABASE_URL=postgresql+asyncpg://postgres@127.0.0.1:5433/be_ins alembic upgrade head

# seed (idempotent: ON CONFLICT DO NOTHING / guarded inserts, deterministic IDs)
SEED_DEMO=true INSURANCE_DATABASE_URL=postgresql+asyncpg://postgres@127.0.0.1:5433/be_ins python scripts/seed.py
```
