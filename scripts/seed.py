...
Usage:
  SEED_DEMO=true INSURANCE_DATABASE_URL=postgresql+psycopg://... python scripts/seed.py
"""
import os
import sys
...
def main() -> int:
    ...
    if os.environ.get("SEED_DEMO", "").lower() != "true":
        ...
        return 1
    url = os.environ.get("INSURANCE_DATABASE_URL") or os.environ.get("DATABASE_URL")
    if not url:
        print("INSURANCE_DATABASE_URL is required", file=sys.stderr)
        return 1
